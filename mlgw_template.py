...
def mlgw_template(params, detector_dictionary):
    ...
    sampling_frequency      = detector_dictionary["sampling_rate"]
    duration                = detector_dictionary["T"]  # Duration of the data segment in seconds
    ...
    h_p,h_c                 = gwgen.get_WF(theta = theta,t_grid = time_array_mlgw, modes=(2,2))
